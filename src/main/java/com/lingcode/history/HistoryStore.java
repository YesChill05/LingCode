...
public class HistoryStore {
    ...
    /** Default constructor &mdash; stores history in {@code ~/.lingcode/prompt_history.jsonl}. */
    public HistoryStore() {
        this(Path.of(System.getProperty("user.home"), ".lingcode", "prompt_history.jsonl"));
    }
