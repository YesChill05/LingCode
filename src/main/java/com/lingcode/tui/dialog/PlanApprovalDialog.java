package com.lingcode.tui.dialog;

import com.lingcode.tui.Styles;
import com.lingcode.tui.tea.Style;
import com.lingcode.tui.tea.ANSI256Color;
 ...
 * It is driven by {@code LingCodeModel}, which calls {@link #handleKey(String)}
 * on every key press and {@link #render()} each frame.
 *
 * @see com.lingcode.tui.LingCodeModel
 */
public class PlanApprovalDialog {
    ...
    public String render() {
        ...
        sb.append(HEADER_STYLE.render(
                " LingCode has written up a plan and is ready to execute. Would you like to proceed?"));
        sb.append("\n\n");
