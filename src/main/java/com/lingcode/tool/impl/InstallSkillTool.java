package com.lingcode.tool.impl;

import com.lingcode.skill.InstallReport;
import com.lingcode.skill.SkillCatalog;
import com.lingcode.skill.SkillInstaller;
import com.lingcode.skill.SkillSource;
...
/**
 * 从 URL 下载并安装 skill 到用户全局目录 (~/.lingcode/skills/)。
 * <p>
...
public class InstallSkillTool implements Tool {
    ...
    private static final String DESCRIPTION =
            ...
            + "(~/.lingcode/skills/). Supports skills.sh URLs (https://www.skills.sh/<owner>/<repo>/<name>), "
    ...
    private String installRoot;   // 为空时自动取 ~/.lingcode/skills
