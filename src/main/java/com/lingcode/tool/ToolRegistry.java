...
public class ToolRegistry {
    ...
    public static ToolRegistry createDefault() {
        ...
        reg.register(new com.lingcode.tool.impl.ReadFileTool());
        reg.register(new com.lingcode.tool.impl.WriteFileTool());
        reg.register(new com.lingcode.tool.impl.EditFileTool());
        reg.register(new com.lingcode.tool.impl.BashTool());
        reg.register(new com.lingcode.tool.impl.GlobTool());
        reg.register(new com.lingcode.tool.impl.GrepTool());
        return reg;
    }
}
