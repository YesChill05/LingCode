 ...
 *   <li>User-level definitions from {@code ~/.lingcode/agents/*.md}</li>
 *   <li>Project-level definitions from {@code <projectRoot>/.lingcode/agents/*.md}</li>
 * </ol>
...
public final class AgentLoader {
    ...
    public static Map<String, SubAgentSpec> loadAll(Path projectRoot) {
        ...
        if (home != null && !home.isEmpty()) {
            loader.loadDir(Path.of(home, ".lingcode", "agents"));
        }

        if (projectRoot != null) {
            loader.loadDir(projectRoot.resolve(".lingcode").resolve("agents"));
        }
