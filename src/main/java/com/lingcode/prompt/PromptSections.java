...
import com.lingcode.prompt.PromptBuilder.EnvironmentContext;
import com.lingcode.prompt.PromptBuilder.Section;
...
public final class PromptSections {
    ...
    static final String IDENTITY_CONTENT = """
            You are LingCode, an AI programming assistant running in the terminal. You help users with \
