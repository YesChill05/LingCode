...
public class PromptBuilder {
    ...
    /**
     * skillSection 是 Skill 系统注入到 System Prompt 的描述文本。
     * 项目指令与自动记忆不走这里，由 ConversationManager.injectLongTermMemory
     * 以 system-reminder 消息注入对话。
     */
    public record BuildOptions(String skillSection) {}
